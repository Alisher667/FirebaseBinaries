...
SWIFT_CLASS("_TtC17FirebaseFunctions13FUNSerializer")
...
- (nonnull instancetype)initWithProjectID:(NSString * _Nonnull)projectID region:(NSString * _Nonnull)region customDomain:(NSString * _Nullable)customDomain auth:(id <FIRAuthInterop> _Nullable)auth messaging:(id <FIRMessagingInterop> _Nullable)messaging appCheck:(id <FIRAppCheckInterop> _Nullable)appCheck fetcherService:(GTMSessionFetcherService * _Nonnull)fetcherService OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL_NAMED("FunctionsProvider")
@protocol FIRFunctionsProvider
- (FIRFunctions * _Nonnull)functionsFor:(FIRApp * _Nonnull)app region:(NSString * _Nullable)region customDomain:(NSString * _Nullable)customDomain type:(Class _Nonnull)type SWIFT_WARN_UNUSED_RESULT;
@end

@class FIRComponent;

SWIFT_CLASS_NAMED("FunctionsComponent")
@interface FIRFunctionsComponent : NSObject <FIRLibrary, FIRFunctionsProvider>
...
SWIFT_CLASS("_TtC17FirebaseFunctions16FunctionsContext")
@interface FunctionsContext : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC17FirebaseFunctions24FunctionsContextProvider")
@interface FunctionsContextProvider : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
